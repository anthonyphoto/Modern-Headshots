...
export class MyacctPage extends React.Component {
    ...
    render() {
        console.log("past from ma", this.props.pastEvents);
        console.log("future from ma", this.props.futureEvents);
        ...
        return (
            <div className='bg-peach'>
                ...
                <div className="ma-al-m">
                    ...
                    <p className='txt ma-spc-l'>You can check your photos and schedules here<br/>
                    </p>
                    </div>
