                ...
                <div className="row info-div bd">
                    ...
                    <div className="mgt-6">
                        ...
                        <div className="box-div mgt-4">
                            ...
                            <p className='txt'>
                                Although my main job is a software engineer as shown on my <a href="https://www.linkedin.com/in/myanthony/" target="_blank">LinkedIn</a>, I am also a photo enthusiast.  
                            </p>
                            {/* <p className='txt'>
                            ...
                            <p className='txt'>
                                I would like to offer you a headshot session in the Philadelphia area for free or with a minimal charge. 
                            </p>
                            <p className='txt'>
                            ...
                            <ul>
                                <li className='txt'>Please book your session from here <Link className="info-spc-l no-undln" to="/schedule"> > </Link></li>
                                <li className='txt'>I apologize for my limited availability</li>
                            </ul>
                            <div className='int-h2 i'>2. Shoot</div>
                            <ul>
                                <li className='txt'>Please visit my place with a desired outfit</li>
                                <li className='txt'>A headshot session takes from 30min up to 1 hour</li>
                            </ul>
